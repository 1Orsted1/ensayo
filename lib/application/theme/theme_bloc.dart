...
//     //   try {
//     //     final SelectedTheme? theme = facade.getThemeName();
//     //     if (theme != null) {
...
//   @override
//   ThemeState? fromJson(Map<String, dynamic> json) => json['selectedTheme'] != null
//       ? ThemeState(selectedTheme: SelectedTheme.values[json['selectedTheme']])
//       : null;
  
//   @override
//   Map<String, dynamic> toJson(ThemeState state) => { 'selectedTheme': state.selectedTheme };
// }
